sed -i '/<span>{language === '"'"'fr'"'"' ? '"'"'S’abonner au Club des Lecteurs'"'"' : '"'"'Subscribe to Readers Club'"'"'}<\/span>/a\
            </button>\
            ...
            >\
              ...
              <span>{language === "fr" ? "Continuer avec Google" : "Continue with Google"}</span>' src/pages/AuthPage.tsx
