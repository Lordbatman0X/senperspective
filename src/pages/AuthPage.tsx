        ...
        {authTab === 'newsletter' ? (
          ...
          <form onSubmit={handleNewsletterSubmit} className="space-y-4 text-left">
            ...
            <button
              ...
              disabled={isSubmitting}
              className="w-full py-3.5 bg-white text-black text-xs font-bold uppercase tracking-wider hover:opacity-90 transition-opacity cursor-pointer flex items-center justify-center gap-2"
            >
